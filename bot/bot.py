...
async def _vision_message_handle_fn(
    ...
    if current_model != "gpt-4":
        await update.message.reply_text(
            "🥲 Images processing is only available for <b>gpt-4</b> model. Please change your settings in /settings",
...
async def voice_message_handle(update: Update, context: CallbackContext):
    ...
    await message_handle(update, context, message=transcribed_text[0])
